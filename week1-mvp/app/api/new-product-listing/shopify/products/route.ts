...
import { syncShopifyProduct, type ShopifyProductDraftInput } from "@/lib/new-product-listing-shopify";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await syncShopifyProduct(user.id, deviceId, body.product);
